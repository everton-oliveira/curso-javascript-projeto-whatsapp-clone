    ...
    initEvents() {
        ...
        this.el.btnSendPicture.on('click', e => {
            ...
            picture.onload = e => {
                ...
                Base64.toFile(canvas.toDataURL(mimeType)).then(file => {
                    Message.sendImage(this._activeContact.chatId, this._user.email, file);           
    ...
    */
    ...
    setActiveChat(contact) {
        ...
        if (this._activeContact) {
            let unsubscribe = Message.getRef(this._activeContact.chatId).onSnapshot(() => {});
            unsubscribe();
        }
        ...
        Message.getRef(this._activeContact.chatId).orderBy('timeStamp').onSnapshot(docs => {
            ...
            docs.forEach(doc => {
                ...
                if (!view) {
                    ...
                    view.querySelector('.message-status').innerHTML = message.getStatusViewElement().outerHTML;
            ...
            if (autoScroll) {
                ...
                scrollTop = this.el.panelMessagesContainer.scrollHeight - this.el.panelMessagesContainer.offsetHeight;
